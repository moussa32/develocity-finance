...
const ProjectsDropdown = () => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left w-full">
      ...
      >
        <Menu.Items className="absolute mx-auto h-[auto] w-[90vw] p-2 md:p-4 inset-x-0 mt-5 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10 md:pb-8 md:px-9 lg:left-[-300px] lg:top-[25px] md:w-[680px] md:h-[365px]">
          <Image
                    ...
                    <div className="md:flex gap-4 px-2 md:px-4 py-2 text-sm">
                      ...
                      <div className="md:mt-3">
                        <h3 className="md:text-base text-[#101828] font-semibold mb-1">
                          {
                            t?.headSection?.projects?.multiFunctionalTool
                              ?.mainText
                          }
                        </h3>
