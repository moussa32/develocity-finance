        ...
        <article className="container px-6 mx-auto relative min-w-full mb-24 pt-16 md:pt-56 lg:px-0 lg:pt-[372px]">
          ...
          <div className="md:w-4/5 lg:max-w-[800px] mx-auto mt-8 md:mt-16 text-[#667085] font-medium text-base">
            ...
            <p className="my-6">
              ...
              consectetur dictum. Donec vulputate purus ac augue bibendum, vitae dapibus urna ornare. In pharetra id
              orci et viverra. Ut consequat lorem eu turpis feugiat semper. Suspendisse semper lorem eros, ac pharetra
              nunc semper ut. Nulla leo orci, mollis euismod tincidunt in, porttitor in leo. Nunc urna augue,
              scelerisque quis metus malesuada, suscipit ornare enim. Curabitur maximus accumsan neque eget vehicula.
              Praesent at quam egestas, aliquet libero ut, malesuada dolor. Integer a nisl ex. Sed ultricies tristique
              dictum. Sed consequat eleifend augue eget venenatis.
            </p>
            <p className="my-6">
              Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Etiam ut nisl
              nulla. Phasellus vel consectetur velit, id commodo libero. Phasellus nec tortor justo. Fusce finibus
              feugiat lacus quis euismod. Nam augue diam, hendrerit at arcu at, tristique ullamcorper est. Proin
              sagittis, justo sed vestibulum porta, tortor nunc sagittis ligula, hendrerit semper justo nisi id turpis.
              Integer elementum, quam non vehicula cursus, libero odio viverra nibh, nec tincidunt est metus vel urna.
              Etiam at accumsan massa. Curabitur in tellus et ligula varius porta. Etiam pulvinar, ligula non placerat
              suscipit, urna diam consectetur dolor, nec commodo lacus ipsum ac ligula. Aliquam varius pulvinar
              efficitur. Donec dignissim vehicula sagittis. Mauris facilisis justo in ex placerat elementum.
            </p>
            <p className="my-6">
              Ut et bibendum justo. Sed efficitur augue non venenatis pretium. Suspendisse ac nulla congue, lobortis
              tellus a, iaculis velit. Maecenas auctor, lorem vel sagittis vestibulum, eros est placerat libero,
              dignissim hendrerit nibh sem id nulla. Suspendisse hendrerit finibus dolor, sed molestie dui faucibus vel.
              Ut justo ante, euismod quis auctor eu, semper a ipsum. Phasellus et eleifend nisi.
            </p>
            <p className="mt-8">
              Nulla sed aliquam massa, ac tempus erat. Donec diam ex, feugiat et orci ac, dictum dictum lacus. Fusce
              rutrum velit sed massa congue, nec gravida quam semper. Proin congue ultricies varius. Donec in lorem
              finibus, faucibus purus et, feugiat justo. Suspendisse eget tempus nunc. Vivamus egestas nulla nulla,
              vitae semper dolor dapibus eu. Mauris et lobortis velit. Donec in ipsum sit amet neque aliquet convallis
              quis vitae nulla.
            </p>
