  ...
  return (
    <div className="relative main-bg bg-center bg-no-repeat text-center overflow-hidden w-full md:bg-cover md:bg-right md:text-left md:h-[810px]">
      ...
      {/* <div className="fixed w-full z-40">
        <Navbar containerClassName={"bg-opacity-0"} />
      </div> */}
      <SideMenu />
      <div className="container mx-auto text-white mt-64 z-20 flex flex-col">
        <div className="w-50 md:w-[615px] md:h-[400px] flex flex-col justify-center z-20">
          <div className="flex flex-col justify-center">
            <h2 className="md:text-6xl text-4xl mb-6">Pre-Sale Countdown</h2>
            <time className="md:text-6xl text-4xl text-center mt-[30px]">
              {`${timeLeft.days}:${timeLeft.hours}:${timeLeft.minutes}:${timeLeft.seconds}`}
            </time>
          </div>
          <div className=" w-full flex justify-center md:justify-start">
            <div className="mt-[125px] w-11/12 h-16 bg-gray-500 bg-opacity-25 rounded-lg flex items-center">
              <div className="ml-3 p-2 rounded-lg  bg-gray-300 bg-opacity-20">
                <img className="w-[18px] h-[18px]" src={`${Loudspeaker}`} />
              </div>
