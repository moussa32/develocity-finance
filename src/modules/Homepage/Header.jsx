...
const Header = () => {
  ...
  return (
    <div className="relative header-bg bg-cover bg-center bg-no-repeat text-center overflow-hidden w-full md:bg-cover md:bg-right md:text-left md:h-[810px]">
      <SideMenu />
      <div className="container mx-auto text-white mt-60 z-20 flex flex-col">
        <div className="w-50 mx-auto flex flex-col justify-center z-20 md:h-[400px] lg:px-8 lg:ml-0 xl:w-[615px] xl:px-0">
          <div className="flex flex-col justify-center">
            <h2 className="font-PolySans text-4xl mb-6 md:mb-0 sm:text-5xl md:text-6xl">
              Pre-Sale Countdown
            </h2>
          ...
          <div className=" w-full flex justify-center md:justify-start">
            <div className="px-3.5 mt-[125px] w-11/12 h-16 bg-gray-500 bg-opacity-25 rounded-lg flex items-center gap-3">
        ...
        <div className="mt-20 mb-14 flex flex-wrap justify-evenly mx-auto px-4 gap-x-3 gap-y-6 md:my-14 md:mt-24 md:gap-10 lg:gap-y-0">
          <img
