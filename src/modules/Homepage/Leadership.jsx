    ...
    <div className="text-center my-24">
      <div className="font-PolySans container mx-auto">
        ...
        <div className="grid mt-6 gap-6 grid-cols-1 lg:grid-cols-3">
          <div className="relative mx-8 px-6 pt-[27px] pb-[27px] rounded-xl bg-gradient-to-t from-[#280D46] to-[#DC88F9] h-96">
          ...
          <div className="relative mx-8 px-6 pt-[27px] pb-[27px] rounded-xl bg-gradient-to-t from-[#101828] to-[#8DA4C9] h-96">
            <div className="absolute bottom-0 right-0 left-0 bg-slate-400 opacity-25 z-0  h-24"></div>
            <div className="absolute bottom-0 right-0 left-0 z-20">
              <div className="px-3 pt-4 pb-2 text-left text-white z-50">
          ...
          <div className="relative mx-8 px-6 pt-[27px] pb-[27px] rounded-xl bg-gradient-to-t from-[#030A13] to-[#859AFF] h-96">
            <div className="absolute bottom-0 right-0 left-0 bg-slate-400 opacity-25 z-0  h-24"></div>
            <div className="absolute bottom-0 right-0 left-0 z-20">
              <div className="px-3 pt-4 pb-2 text-left text-white z-50">
