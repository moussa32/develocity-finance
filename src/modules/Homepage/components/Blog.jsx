  ...
  return (
    <div className="text-center my-32">
      <div className="container mx-auto">
        <h2 className="text-6xl text-indigo-900" style={{ color: "#29233B" }}>
          Develocity Blog
        </h2>
        <p className="text-sm mt-4 capitalize" style={{ color: "#525C7A" }}>
          News, updates, and useful content from across the Develocity
          Ecosystem.
        </p>
        <div className="w-10/12 mt-10 container mx-auto">
          <div className="gap-6 grid grid-cols-1 lg:grid-cols-2">
            <div className="shadow-xl shadow-gray-300 flex flex-col rounded-lg">
              <div className="text-left w-5/6 container mx-auto mt-10 flex flex-col">
                <p className="text-3xl capitalize" style={{ color: "#29233B" }}>
                ...
                <Link to={"blog"} className="mt-5" style={{ color: "#6366F1" }}>
                  Learn More →
                </Link>
              </div>
