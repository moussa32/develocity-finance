...
export default function StatsSection() {
  ...
  return (
    <div className="container absolute top-[4100px] md:top-[3850px] lg:top-[3950px] right-0 left-0">
      <div className="mx-auto flex flex-col md:w-10/12 h-[204px] md:h-[700px] md:mb-10">
