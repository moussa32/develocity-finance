      ...
      <div className="container mx-auto pt-24 pb-16 text-center md:text-left text-[#525C7A] text-base font-medium">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div>
            ...
            <div className="mt-6">
              <NavLink className="block md:inline-block md:mr-6 mt-6 md:mt-0 ">Returns & FAQ</NavLink>
              <NavLink className="block md:inline-block md:mr-6 mt-6 md:mt-0 ">Privacy Policy</NavLink>
              <NavLink to="/contact-us" className="block md:inline-block md:mr-6 mt-6 md:mt-0 ">
                Contact
              </NavLink>
              <NavLink className="block md:inline-block md:mr-6 my-6 md:my-0 ">Back to Develocity</NavLink>
            </div>
          </div>
