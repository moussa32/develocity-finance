      ...
      <section className="container px-10 xl:px-0 mx-auto mb-32 lg:mb-[275px]">
        ...
        <div className="grid grid-cols-1 gap-x-6 lg:grid-cols-2 xl:gap-x-[117px]">
          ...
          <div className="mt-6 lg:mt-0 text-center lg:text-left">
            <h2 className="text-3xl lg:text-5xl font-semibold text-[#29233B]">
              Contact form
            </h2>
            <p className="font-medium mt-3 mb-9 text-sm">
              ...
              <a
                ...
                href="mailto:info@develocity.finance"
              >
            ...
            <form className="xl:max-w-[512px] mx-auto xl:mx-0">
              <div className="flex flex-col lg:grid lg:grid-cols-2 gap-y-6 lg:gap-x-8">
                <div className="font-medium">
                  <label className="block text-sm mb-1.5 text-[#344054]">
                    First name
                  </label>
                  <input
              ...
              <div className="flex gap-3 items-center mt-4">
                ...
                <input
                  className="order-1 w-5 h-5 border border-[#D0D5DD] rounded"
                  type="checkbox"
                />
              </div>
              <button
                className="bg-indigo-500 w-full text-white h-[52px] rounded-sm mt-8"
                type="submit"
              >
                SEND
              </button>
