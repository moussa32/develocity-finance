      ...
      <div className="flex flex-col md:grid grid-cols-1 md:grid-cols-2 md:gap-8">
        <div className="flex flex-col order-2 md:order-1">
          <span className="bg-[#F3F4F8] w-full rounded-2xl text-sm font-medium p-1 md:p-1.5 md:pr-[18px] flex items-center gap-2 md:max-w-[360px] lg:flex-row">
            <span className="bg-white py-0.5 px-2 md:py-1 md:px-2.5 rounded-2xl">Eco-System</span>
            <span className="text-[#344054]">Safe Eenviroment For Your Assets</span>
          </span>
          ...
          <div className="flex flex-wrap lg:grid lg:grid-cols-2 mt-8 gap-y-4">
            <div className="flex items-center w-3/5 mr-5 lg:mr-0 lg:w-full">
              ...
              <h4 className="ml-2 text-[#171717] font-medium text-base">Multi-functional Tool</h4>
            </div>
            <div className="flex items-center">
              <Image src={SwapToolIcon} className="w-8 h-8" alt="SwapToolIcon" />
              <h4 className="ml-2 text-[#171717] font-medium text-base">Swap Tool</h4>
            </div>
            <div className="flex items-center w-3/5 mr-5 lg:mr-0 lg:w-full">
              <Image src={CryptoAcademyIcon} className="w-8 h-8" alt="CryptoAcademyIcon" />
              <h4 className="ml-2 text-[#171717] font-medium text-base">Crypto Academy</h4>
            </div>
            <div className="flex items-center">
              <Image src={BridgeIcon} className="w-8 h-8" alt="BridgeIcon" />
              <h4 className="ml-2 text-[#171717] font-medium text-base">Bridge</h4>
            </div>
            <div className="flex items-center w-3/5 mr-5 lg:mr-0 lg:w-full">
            ...
            <div className="flex items-center">
              ...
              <h4 className="ml-2 text-[#171717] font-medium text-base">Wallet</h4>
            </div>
          </div>
        </div>
