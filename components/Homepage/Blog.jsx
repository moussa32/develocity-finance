import phoneImage from "@/images/blog-phone.png";
    ...
    <div className="text-center mt-28 mb-[59px] md:mt-32 md:mb-32">
      <div className="container mx-auto">
        <div className="mx-auto max-w-[800px] mb-12">
          <h2 className="font-PolySans text-[28px] text-[#171717] md:text-6xl  md:text-[#29233B]">
        ...
        <div className="flex justify-center items-center">
          <div className="gap-9 grid grid-cols-1 lg:grid-cols-2">
            <div className="home-blog-card-shadow bg-slate-50 flex flex-col justify-center rounded-lg overflow-hidden h-[650px] max-w-[488px]">
              <div className="ltr:text-left rtl:text-right md:mx-8 my-8 mb-0 flex flex-col">
                <h3 className="text-[28px] font-semibold px-2 md:px-0 md:text-3xl capitalize text-[#29233B]">
                  {t?.homeSection?.blogSection?.cards[0]?.mainText}
                </h3>
                <p className="text-base mt-4 ltr:pl-2 ltr:md:pl-0 rtl:pr-2 rtl:md:pr-0 text-[#525252] md:text-[#525C7A]">
            ...
            <div className="home-blog-card-shadow bg-slate-50	 flex flex-col pb-6 md:pb-10 rounded-lg h-[600px] md:h-[650px] max-w-[488px]">
        ...
        <div className="text-lg mt-[46px] md:mt-[60px] text-indigo-500 font-semibold">
          <Link href="/blog"> {t?.homeSection?.blogSection?.checkMoreNewsBtn}</Link>
        </div>
      </div>
    </div>
  );
