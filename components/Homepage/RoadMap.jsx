        ...
        <div className="hidden md:block px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:px-20 gap-8 lg:gap-2 mt-16">
            <div className="mx-auto text-center">
              ...
              <span className="text-base text-[#B8B8B8] mt-2">{t?.homeSection?.roadmapSection?.cards?.startup?.lable}</span>
            </div>
            <div className="mx-auto text-center">
              ...
              <span className="text-base text-[#B8B8B8] mt-2">{t?.homeSection?.roadmapSection?.cards?.fairlaunch?.lable}</span>
            </div>
            <div className="mx-auto text-center">
              ...
              <span className="text-base text-[#B8B8B8] mt-2">{t?.homeSection?.roadmapSection?.cards?.expansion?.lable}</span>
            </div>
            <div className="mx-auto text-center">
              ...
              <span className="text-base text-[#B8B8B8] mt-2">{t?.homeSection?.roadmapSection?.cards?.opportunities?.lable}</span>
            </div>
          </div>
